...
const SingleProduct = ({ product, brandName, averageRating }) => {
  ...
  return (
    <div
      ...
      className="border dark:hover:bg-cyan-600 hover:bg-cyan-100 border-gray-700 dark:border-gray-300 rounded-xl p-2 shadow-lg cursor-pointer hover:shadow-xl transition-all duration-300"
    >
