...
const OrderSuccessPage = () => {
  ...
  // PURCHASE EVENT (duplicate prevent)
  useEffect(() => {
    if (!order?._id || !state?.orderData) return;

    const fired = sessionStorage.getItem("purchase_" + order._id);
    ...
    if (!fired) {
      ...
      sessionStorage.setItem("purchase_" + order._id, "true");
      console.log("GTM Fired: purchase");
    }
  }, [order]);
